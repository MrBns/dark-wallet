	...
	<div class="flex items-center gap-2">
		<div class="text-[0px] md:hidden">
			<button
				...
				class="p-1 border rounded text-stone-700 active:bg-primary-300 border-dark-300"
				><iconify-icon icon={iconify.viewDetails} class="text-2xl"></iconify-icon></button
			>
		</div>
		<div
			class="text-center flex-1 border p-1 rounded leading-tight flex text-slate-500 gap-2 items-center text-xl/none"
		>
		...
		<div
			class="text-center flex-1 border p-1 rounded leading-tight flex text-stone-500 gap-2 items-center text-xl/none"
		>
